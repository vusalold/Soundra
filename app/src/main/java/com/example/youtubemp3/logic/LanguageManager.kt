...
enum class AppLanguage(val tag: String, val labelResId: Int) {
    AZERBAIJANI("az", com.vusal.soundra.R.string.lang_az),
    TURKISH("tr", com.vusal.soundra.R.string.lang_tr),
    ENGLISH("en", com.vusal.soundra.R.string.lang_en),
    RUSSIAN("ru", com.vusal.soundra.R.string.lang_ru);
