...
import com.vm.soundra.logic.RecommendationEngine
import com.vm.soundra.repository.search.RecommendationRepository
import com.vm.soundra.repository.search.SearchHistoryRepository
import com.vm.soundra.repository.search.SearchRepository
    ...
    fun loadRecommendations(force: Boolean = false) {
        viewModelScope.launch {
            ...
            try {
                ...
                _uiState.value = SearchUiState.Error(com.vm.soundra.R.string.err_load_failed)
